...
## База Данных
Есть две таблицы, одна под заказы, вторая под географическое положение. Столбцы *from_node* и *to_node* таблицы *orders* связаны с *id* таблицы *nodes* 
![Database Graph](misc/db.png)
